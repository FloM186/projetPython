...
controls_reg_lin = [spinner_cv_lin,var_cible_reg_lin_select,var_pred_reg_lin_choice, strategy_imputer_reg_lin, slider_reg_lin_train_test, slider_reg_lin_alpha, slider_reg_lin_alpha_pas, slider_reg_lin_L1pen]
...
def update_reg_lin():
    ...
    from sklearn.datasets import make_regression
    # Création du modèle
    model = ElasticNetCV(cv=spinner_cv_lin.value, random_state=0, l1_ratio=slider_reg_lin_L1pen.value, normalize=True,
                                                alphas=np.arange(0, slider_reg_lin_alpha.value, slider_reg_lin_alpha_pas.value).tolist())
...
reglineaire = Panel( child= Column(Row(var_cible_reg_lin_select, var_pred_reg_lin_choice), 
                                Row(slider_reg_lin_train_test, strategy_imputer_reg_lin, spinner_cv_lin),
