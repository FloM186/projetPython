...
res_lr = PreText(text='', width=500, height=100)
...
logist = Panel( child= Column(Row( var_cible_reg_log_select, var_pred_reg_log_choice), res_lr ), title='Régression Logistique' )
